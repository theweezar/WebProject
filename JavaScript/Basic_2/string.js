...
function Example_String() {
  ...
  console.log("Split(' '): ");
  console.log(str.split(" ")); // tách chuỗi theo điều kiện và nhét từng phần tử được tách vào 1 array
  console.log("Substr(0,10): ");
  console.log(str.substr(0,10)); // substr với slice khá giống nhau đều hỗ trợ cắt chữ từ đâu tới đâu
  console.log("Slice(0,10): ");
  console.log(str.slice(0,10));
  console.log("Replace('ai','Duc'): ");
  console.log(str.replace("ai","Duc")); // thay đổi chữ "ai" thành chữ "Duc"
}
// Example_String();
